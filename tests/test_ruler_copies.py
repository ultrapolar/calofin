...
once in shared/parts/CALOFIN-LIB.lsp under cal:, and thirteen
...
SPA, OASIS, POOLSIDE, FITABHD, CONSTELLATION and ABHD.  The grouped
...
made in the library and copied out to the thirteen files (the same rule
...
COPIES = [
    ...
    ("CONSTELLATION", "lisp/constellation/CONSTELLATION.lsp", "cst:"),
    ("abhd", "lisp/abhd/abhd.lsp", "pf:"),
]
