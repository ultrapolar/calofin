...
once in shared/parts/CALOFIN-LIB.lsp under cal:, and twelve
...
SPA, OASIS, POOLSIDE, FITABHD and CONSTELLATION.  The grouped
...
made in the library and copied out to the twelve files (the same rule
