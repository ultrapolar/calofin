...
| `OASIS`, `OASISVER` | `lisp/oasis/` | Continuous-tangent pool in four shapes - centre bulge, top-right bulge, straight-bottom or rounded-bottom cloud - drawn live as its X/Y envelope and radii are answered, with a centre-to-corner check drawing beside it |
