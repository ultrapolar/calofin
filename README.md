...
`LAZPANEL` is pure AutoLISP, ships inside `LAZPASS.lsp`, covers the 71
...
python3 tests/test_vsconv.py          # VSCONV - a VS export converted onto the
                                      ...
                                      # rename, and the cut-short paths
