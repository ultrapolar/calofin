...
| `OASIS`, `OASISVER` | `lisp/oasis/` | Continuous-tangent pool - six arcs, no corners - drawn live as its X/Y envelope and six radii are answered, with a centre-to-corner check drawing beside it |
