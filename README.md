...
| ABHD (AutoLISP, AutoCAD 2018+) | `pool_fit_lisp/` | Builds a closed polyline (lines + arcs, as few curves as possible, optional curve cap) through pool-edge survey points — guided by a drawn perimeter, a connect-the-dots sketch, or the points alone — see `pool_fit_lisp/README.md` |
