...
| grouped | `shared/parts/` | the same tools rebuilt against one helper library (`cal:` namespace), all loading together; `shared/CALOFIN-ALL.lsp` is the generated one-file build | generated by `tools/mirror_shared.py` where listed, by hand otherwise; bundle generated |
