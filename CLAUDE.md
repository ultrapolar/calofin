...
| grouped | `shared/parts/` | the same tools rebuilt against one helper library (`cal:` namespace), all loading together; `shared/CALOFIN-ALL.lsp` is the generated one-file build | mirrored by hand, bundle generated |
...
3. Mirror the change into `shared/parts/<FILE>.lsp`.
4. Regenerate:
   ```
