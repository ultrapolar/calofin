...
| Group | Buttons |
| --- | --- |
| Layout | LAZFORM, SPA, POOL, POOLDEMO, OASIS, FITABHD, ABHD, ADAB, CABHD, LHD, PADDLE, LINGUTTER, LINGUTTERSCAN, AUTOBEAD, CORNERSTP, HEMISTEP, NORMIESTEP, STOCKCOVER, WCALST |
