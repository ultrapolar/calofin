...
-- 77 of them across 178 buttons, because the pages come in two kinds
...
| Points | ABCDEF, ALTABCDEF, XYPLOT, CONSTELLATION, ABFIND, ABMOVE, ABPCREATE, POINTRENAMER, PERPPTS, CPERPPTS, XFTCONV, XFTRECONV, SOCONV, SORECONV, VSCONV, VSRECONV, G2MCONV, G2MRECONV, DRONE, TYDRN, TYLERDRONESUITE |
