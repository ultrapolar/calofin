...
echo "    (princ), lzd:watch after a selection and"
echo "    lzd:ask in an ask helper.  A NEW tool gets these too - write the"
echo "    handler, then python3 tools/check_lazdiag.py --fix wires the rest"
