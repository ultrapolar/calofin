...
TOOLS = {
    'SPA': {
        ...
        'swap': {
            ...
            # the length ruler beside the corner-size prompts: one
            # block, held to the library by tests/test_ruler_copies.py;
            # the style builder, the scratch layer, the sweeper and
            # spa:rulerup stay local, since each reads this file's
            # own knobs
            'spa:len-digit-p': 'cal:len-digit-p',
            'spa:len-num-p': 'cal:len-num-p',
            'spa:len-split': 'cal:len-split',
            'spa:len-token': 'cal:len-token',
            'spa:len-inches': 'cal:len-inches',
            'spa:parse-len': 'cal:parse-len',
            'spa:len-eighths': 'cal:len-eighths',
            'spa:spell-len': 'cal:spell-len',
            'spa:len-unread': 'cal:len-unread',
            'spa:ruler-tier': 'cal:ruler-tier',
            'spa:ladder-tier': 'cal:ladder-tier',
            'spa:ladder-rows': 'cal:ladder-rows',
            'spa:ruler-rows': 'cal:ruler-rows',
            'spa:ruler-val-lt': 'cal:ruler-val-lt',
            'spa:ruler-view': 'cal:ruler-view',
            'spa:ruler-dir': 'cal:ruler-dir',
            'spa:ruler-hgt': 'cal:ruler-hgt',
            'spa:ruler-tick': 'cal:ruler-tick',
            'spa:ruler-line': 'cal:ruler-line',
            'spa:ruler-ring': 'cal:ruler-ring',
            'spa:ruler-label': 'cal:ruler-label',
            'spa:draw-ruler': 'cal:draw-ruler',
            'spa:ruler-hit': 'cal:ruler-hit',
            'spa:ruler-new': 'cal:ruler-new',
            'spa:ruler-off': 'cal:ruler-off',
            'spa:ruler-show': 'cal:ruler-show',
            'spa:ask-len': 'cal:ask-len',
        },
    ...
    'PERPMARK': {
        ...
        'swap': {
            ...
            'pm:ladder-tier': 'cal:ladder-tier',
            'pm:ladder-rows': 'cal:ladder-rows',
    ...
    'POOL': {
        ...
        'swap': {
            ...
            # the length ruler beside the corner-size prompts: one
            # block, held to the library by tests/test_ruler_copies.py;
            # the style builder, the scratch layer and the sweeper stay
            # local, since each reads this file's own knobs
            'pool:len-digit-p': 'cal:len-digit-p',
            'pool:len-num-p': 'cal:len-num-p',
            'pool:len-split': 'cal:len-split',
            'pool:len-token': 'cal:len-token',
            'pool:len-inches': 'cal:len-inches',
            'pool:parse-len': 'cal:parse-len',
            'pool:len-eighths': 'cal:len-eighths',
            'pool:spell-len': 'cal:spell-len',
            'pool:len-unread': 'cal:len-unread',
            'pool:ruler-tier': 'cal:ruler-tier',
            'pool:ladder-tier': 'cal:ladder-tier',
            'pool:ladder-rows': 'cal:ladder-rows',
            'pool:ruler-rows': 'cal:ruler-rows',
            'pool:ruler-val-lt': 'cal:ruler-val-lt',
            'pool:ruler-view': 'cal:ruler-view',
            'pool:ruler-dir': 'cal:ruler-dir',
            'pool:ruler-hgt': 'cal:ruler-hgt',
            'pool:ruler-tick': 'cal:ruler-tick',
            'pool:ruler-line': 'cal:ruler-line',
            'pool:ruler-ring': 'cal:ruler-ring',
            'pool:ruler-label': 'cal:ruler-label',
            'pool:draw-ruler': 'cal:draw-ruler',
            'pool:ruler-hit': 'cal:ruler-hit',
            'pool:ruler-new': 'cal:ruler-new',
            'pool:ruler-off': 'cal:ruler-off',
            'pool:ruler-show': 'cal:ruler-show',
            'pool:ask-len': 'cal:ask-len',
        },
    ...
    'POOLSIDE': {
        ...
        'swap': {
            ...
            # the length ruler beside the depth prompts: one block,
            # held to the library by tests/test_ruler_copies.py; the
            # style builder, the scratch layer and the sweeper stay
            # local, since each reads this file's own knobs
            'psd:len-digit-p': 'cal:len-digit-p',
            'psd:len-num-p': 'cal:len-num-p',
            'psd:len-split': 'cal:len-split',
            'psd:len-token': 'cal:len-token',
            'psd:len-inches': 'cal:len-inches',
            'psd:parse-len': 'cal:parse-len',
            'psd:len-eighths': 'cal:len-eighths',
            'psd:spell-len': 'cal:spell-len',
            'psd:len-unread': 'cal:len-unread',
            'psd:ruler-tier': 'cal:ruler-tier',
            'psd:ladder-tier': 'cal:ladder-tier',
            'psd:ladder-rows': 'cal:ladder-rows',
            'psd:ruler-rows': 'cal:ruler-rows',
            'psd:ruler-val-lt': 'cal:ruler-val-lt',
            'psd:ruler-view': 'cal:ruler-view',
            'psd:ruler-dir': 'cal:ruler-dir',
            'psd:ruler-hgt': 'cal:ruler-hgt',
            'psd:ruler-tick': 'cal:ruler-tick',
            'psd:ruler-line': 'cal:ruler-line',
            'psd:ruler-ring': 'cal:ruler-ring',
            'psd:ruler-label': 'cal:ruler-label',
            'psd:draw-ruler': 'cal:draw-ruler',
            'psd:ruler-hit': 'cal:ruler-hit',
            'psd:ruler-new': 'cal:ruler-new',
            'psd:ruler-off': 'cal:ruler-off',
            'psd:ruler-show': 'cal:ruler-show',
            'psd:ask-len': 'cal:ask-len',
        },
    ...
    'OASIS': {
        ...
        'swap': {
            ...
            # the length ruler beside the radius prompts: one block,
            # held to the library by tests/test_ruler_copies.py; the
            # style builder, the scratch layer and the sweeper stay
            # local, since each reads this file's own knobs
            'oasis:len-digit-p': 'cal:len-digit-p',
            'oasis:len-num-p': 'cal:len-num-p',
            'oasis:len-split': 'cal:len-split',
            'oasis:len-token': 'cal:len-token',
            'oasis:len-inches': 'cal:len-inches',
            'oasis:parse-len': 'cal:parse-len',
            'oasis:len-eighths': 'cal:len-eighths',
            'oasis:spell-len': 'cal:spell-len',
            'oasis:len-unread': 'cal:len-unread',
            'oasis:ruler-tier': 'cal:ruler-tier',
            'oasis:ladder-tier': 'cal:ladder-tier',
            'oasis:ladder-rows': 'cal:ladder-rows',
            'oasis:ruler-rows': 'cal:ruler-rows',
            'oasis:ruler-val-lt': 'cal:ruler-val-lt',
            'oasis:ruler-view': 'cal:ruler-view',
            'oasis:ruler-dir': 'cal:ruler-dir',
            'oasis:ruler-hgt': 'cal:ruler-hgt',
            'oasis:ruler-tick': 'cal:ruler-tick',
            'oasis:ruler-line': 'cal:ruler-line',
            'oasis:ruler-ring': 'cal:ruler-ring',
            'oasis:ruler-label': 'cal:ruler-label',
            'oasis:draw-ruler': 'cal:draw-ruler',
            'oasis:ruler-hit': 'cal:ruler-hit',
            'oasis:ruler-new': 'cal:ruler-new',
            'oasis:ruler-off': 'cal:ruler-off',
            'oasis:ruler-show': 'cal:ruler-show',
            'oasis:ask-len': 'cal:ask-len',
        },
    ...
    'CORNERSTP': {
        ...
        'swap': {
            ...
            'cs-ladder-tier': 'cal:ladder-tier',
            'cs-ladder-rows': 'cal:ladder-rows',
    ...
    'HEMISTEP': {
        ...
        'swap': {
            ...
            'hs-ladder-tier': 'cal:ladder-tier',
            'hs-ladder-rows': 'cal:ladder-rows',
    ...
    'NORMIESTEP': {
        ...
        'swap': {
            ...
            'ns-ladder-tier': 'cal:ladder-tier',
            'ns-ladder-rows': 'cal:ladder-rows',
    ...
    'cperp_points': {
        ...
        'swap': {
            ...
            'cperp:ladder-tier': 'cal:ladder-tier',
            'cperp:ladder-rows': 'cal:ladder-rows',
    ...
    'perp_points': {
        ...
        'swap': {
            ...
            'perp:ladder-tier': 'cal:ladder-tier',
            'perp:ladder-rows': 'cal:ladder-rows',
